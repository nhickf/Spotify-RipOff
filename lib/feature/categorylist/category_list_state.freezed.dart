...
class _$CategoryListStateImpl implements _CategoryListState {
  _$CategoryListStateImpl({this.layout = Layout.list});
  ...
  @override
  String toString() {
    return 'CategoryListState(layout: $layout)';
  }
...
abstract class _CategoryListState implements CategoryListState {
  factory _CategoryListState({final Layout layout}) = _$CategoryListStateImpl;
